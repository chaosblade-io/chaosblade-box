...
public class ChaosBladeForCloud extends ChaosBase {
  ...
  public ChaosBladeForCloud(
      PaasTransportService transportService, RequestIdProvider requestIdProvider) {
   ...
   * @return
   */
  public Response<String> prepareExpForCloud(
      PrepareArgs prepareArgs, String ak, String sk, String vpcId, String tag) {
    String command = CliUtil.buildPrepareCmd(prepareArgs);
    Request request =
        RequestUtil.createRequest(
            prepareArgs.getMachine(),
            prepareArgs.getPort(),
            prepareArgs.getMachineType(),
            ak,
            sk,
            command);
  ...
  public Response<String> createExpForCloud(
      ModelArgs modelArgs, String ak, String sk, String vpcId, String tag) {
  ...
  public Response<String> destroyExpForCloud(
      String expUid, String scope, String port, String ak, String sk, String vpcId, String tag) {
  ...
  /**
   * 停止实验，兜底方案 modelArgs 中 machine、machineType、target、action 是必须的，matcherFlags 取决于
   * FlagSpecBean#requiredWhenDestroyed 字段，true 则必须填写；
   *
   * @param modelArgs
   * @param ak
   * @param sk
   * @return
   */
  public Response<String> destroyExpForCloudWithoutUid(
      ModelArgs modelArgs, String ak, String sk, String vpcId, String tag) {
   ...
   * @return
   */
  public Response<K8sResultBean> createK8sExpForCloud(
      ModelArgs modelArgs, String ak, String sk, String vpcId, String tag) {
   ...
   * @return
   */
  public Response<K8sResultBean> destroyK8sExpForCloud(
      String expUid, String scope, String port, String ak, String sk, String vpcId, String tag) {
    String destroyCmd = CliUtil.buildDestroyCmd(expUid);
    Request request = RequestUtil.createRequest(scope, port, Target.IP, ak, sk, destroyCmd);
    Response<String> response = transportService.invoke(request, String.class);
   ...
   * @return
   */
  public Response<K8sResultBean> queryK8sExpForCloud(
      String expUid,
      String cmd,
      String scope,
      String port,
   ...
   * @return
   */
  public Response<String> revokeExpForCloud(
      String expUid, String scope, String port, String ak, String sk, String vpcId, String tag) {
   ...
   * @return
   */
  public Response<ExpStatusBean> getExpStatusForCloud(
      String expUid, String scope, String port, String ak, String sk, String vpcId, String tag) {
   ...
   * @return
   */
  public Response<List<ExpStatusBean>> getExpStatusListForCloud(
      String scope, String port, String ak, String sk, String vpcId, String tag) {
    String statusCmd = CliUtil.buildStatusCmd(null, Blade.CREATE);
    Request request = RequestUtil.createRequest(scope, port, Target.IP, ak, sk, statusCmd);
    Response<String> response = transportService.invoke(request, String.class);
    if (response.isSuccess()) {
      List<ExpStatusBean> expStatusBeans =
          JSONObject.parseArray(response.getResult(), ExpStatusBean.class);
   ...
   * @return
   */
  public Response<List<PrepareStatusBean>> getPrepareStatusListForCloud(
      String scope, String port, String ak, String sk, String vpcId, String tag) {
    String statusCmd = CliUtil.buildStatusCmd(null, Blade.PREPARE);
    Request request = RequestUtil.createRequest(scope, port, Target.IP, ak, sk, statusCmd);
    Response<String> response = transportService.invoke(request, String.class);
    if (response.isSuccess()) {
      List<PrepareStatusBean> statusBeans =
          JSONObject.parseArray(response.getResult(), PrepareStatusBean.class);
   ...
   * @return
   */
  public Response<PrepareStatusBean> getPrepareStatusForCloud(
      String expUid, String scope, String port, String ak, String sk, String vpcId, String tag) {
    if (StringUtil.isBlank(expUid)) {
      return Response.ofFailure(Response.Code.FORBIDDEN, "uid is empty");
    }
   ...
   * @return
   */
  public Response<String[]> getNetworkDeviceForCloud(
      String scope, String port, String ak, String sk, String vpcId, String tag) {
    ...
    return Response.ofFailure(
        Response.Code.COMMAND_NOT_FOUND, "query command not found", new String[0]);
  }
   ...
   * @return
   */
  public Response<String[]> getDiskDeviceForCloud(
      String scope, String port, String ak, String sk, String vpcId, String tag) {
   ...
   * @return
   */
  public Response<Long> getHitCountInJvmForCloud(
      String scope, String port, String ak, String sk, String vpcId, String tag, String uid) {
  ...
  /**
   * 查询 k8s jvm 场景命中率 { "uid": "cc8e51b50ec573cb", "success": true, "metrics": [ { "id":
   * "60852d76ec9ff489", // jvm experiment id "type": "jvm", "success": true, "count": 100, // 累计值
   * }, { "id": "2c4644579ff71276", // jvm experiment id "type": "jvm", "success": false, "error":
   * "the experiment record not found", "count": 50, // 累计值 }, ] }
   *
   ...
   */
  public Response<K8sHitCountBean> getHitCountInK8sJvmForCloud(
      String scope, String port, String ak, String sk, String vpcId, String tag, String uid) {
  ...
  /** 检测 混沌实验 */
  public Response<String> checkForCloud(
      ModelArgs modelArgs, String ak, String sk, String vpcId, String tag, String environment) {
