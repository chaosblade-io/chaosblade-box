...
public class K8sResultBean {
  ...
  public K8sResultBean(String uid, List<K8sExpStatusBean> statuses) {
    this.uid = uid;
    this.statuses = statuses;
  }

  public K8sResultBean(String uid, boolean success, String error, List<K8sExpStatusBean> statuses) {
    this.uid = uid;
  ...
  /**
   * 判断实验是否完成 如果是销毁，则判断总的状态，如果是失败，就一直返回失败，直到上层超时
   *
