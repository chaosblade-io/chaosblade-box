...
public class ChaosBladePrepareHttpInvokerTest {

    @Autowired
    private ChaosBladePrepareHttpInvoker chaosBladePrepareHttpInvoker;
    ...
    public void pingTest() throws Throwable {
        ...
        request.setSceneCode("chaosblade.prepare.jvm");
        HashMap<String, String> arguments = new HashMap<>();
        arguments.put("pid", "16321");
        request.setArguments(arguments);

        CompletableFuture<ResponseCommand> future = chaosBladePrepareHttpInvoker.invoke(request);
