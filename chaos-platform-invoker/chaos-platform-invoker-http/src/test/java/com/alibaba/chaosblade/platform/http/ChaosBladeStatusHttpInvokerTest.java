...
public class ChaosBladeStatusHttpInvokerTest {

    @Autowired
    private ChaosBladeStatusHttpInvoker chaosBladeStatusHttpInvoker;
    ...
    public void pingTest() throws Throwable {
        ...
        CompletableFuture<ResponseCommand> future = chaosBladeStatusHttpInvoker.invoke(request);
