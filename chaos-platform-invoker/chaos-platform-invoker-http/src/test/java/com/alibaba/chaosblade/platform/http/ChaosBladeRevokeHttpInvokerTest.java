...
public class ChaosBladeRevokeHttpInvokerTest {

    @Autowired
    private ChaosBladeRevokeHttpInvoker chaosBladeRevokeHttpInvoker;
    ...
    public void pingTest() throws Throwable {
        ...
        request.setName("0ae31918da81acda");

        CompletableFuture<ResponseCommand> future = chaosBladeRevokeHttpInvoker.invoke(request);
