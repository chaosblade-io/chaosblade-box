...
public class NamespaceController extends BaseController {
  ...
  @Autowired
  @Qualifier(value = "cloudNamespaceImpl") private NamespaceService namespaceService;
  ...
  public RestResponse<Namespace> createNamespace(
      @LoginUser ChaosUser user, @RequestBody Map<String, String> params) throws ChaosException {
    ...
    return RestResponseUtil.okWithData(
        namespaceService.addNamespace(
            ...
            StringEscapeUtils.escapeHtml4(user.getUserId()),
            ""));
  }

  @PostMapping("DeleteNamespace")
  public RestResponse<Boolean> deleteNamespace(
    ...
    return RestResponseUtil.okWithData(namespaceService.deleteNamespace(name, user.getUserId()));
  }
}
