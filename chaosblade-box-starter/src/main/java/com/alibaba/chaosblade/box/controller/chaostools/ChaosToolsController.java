...
public class ChaosToolsController extends BaseController {
  ...
  @Autowired private ChaosToolsService chaosToolsService;
  ...
  public RestResponse<List<ToolsOverview>> toolsOverviewList(
      @RequestBody ChaosToolsRequest chaosToolsRequest) {
  ...
  public RestResponse<?> installChaosTools(
      @RequestBody ChaosToolsRequest chaosToolsRequest, @LoginUser ChaosUser chaosUser) {
    chaosToolsRequest.setUserId(chaosUser.getUserId());
    return RestResponseUtil.initWithServiceResponse(
        chaosToolsService.installChaosTools(chaosToolsRequest));
  }
  ...
  public RestResponse<?> uninstallChaosTools(
      @RequestBody ChaosToolsRequest chaosToolsRequest, @LoginUser ChaosUser chaosUser) {
    chaosToolsRequest.setUserId(chaosUser.getUserId());
    return RestResponseUtil.initWithServiceResponse(
        chaosToolsService.uninstallChaosTools(chaosToolsRequest));
  }
}
