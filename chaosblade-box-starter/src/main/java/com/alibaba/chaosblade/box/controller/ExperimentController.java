...
public class ExperimentController extends BaseController {
  ...
  @Autowired private ScopeTypeSelector scopeTypeSelector;

  @ApiOperation(value = "创建新的演练")
  @PostMapping(value = "/CreateExperiment")
  public RestResponse<String> createExperiment(
      @LoginUser ChaosUser chaosUser, @RequestBody ExperimentCreateRequest experimentCreateRequest)
  ...
  public RestResponse<Boolean> updateExperiment(
      @LoginUser ChaosUser chaosUser, @RequestBody ExperimentUpdateRequest experimentUpdateRequest)
      throws ChaosException {
    userPermissionService.checkExperimentPermission(
        PermissionTypes.W,
        chaosUser,
        experimentUpdateRequest.getExperimentId(),
        experimentUpdateRequest.getNamespace(),
        null);
  ...
  public RestResponse<String> cloneExperiment(
      @LoginUser ChaosUser chaosUser, @RequestBody ExperimentCloneRequest experimentCloneRequest) {
    userPermissionService.checkExperimentPermission(
        PermissionTypes.W,
        chaosUser,
        experimentCloneRequest.getExperimentId(),
        experimentCloneRequest.getNamespace(),
        null);
  ...
  public RestResponse<ExperimentRunResult> runExperiment(
      @LoginUser ChaosUser chaosUser, @RequestBody ExperimentRunRequest experimentRunRequest)
      throws ChaosException {
    userPermissionService.checkExperimentPermission(
        PermissionTypes.X,
        chaosUser,
        experimentRunRequest.getExperimentId(),
        experimentRunRequest.getNamespace(),
        null);
  ...
  public RestResponse<ExperimentInfo> queryExperiment(
    ...
    PermissionResult permission =
        userPermissionService.checkExperimentPermission(
            ...
            null);
    Response<ExperimentInfo> experimentInfoResponse =
        experimentReadService.getExperiment(baseExperimentRequest);
  ...
  public RestResponse<Void> deleteExperiment(
      @LoginUser ChaosUser chaosUser, @RequestBody ExperimentDeleteRequest experimentDeleteRequest)
      throws PermissionDeniedException {
    userPermissionService.checkExperimentDeletePermission(
        PermissionTypes.W,
        chaosUser,
        experimentDeleteRequest.getExperimentId(),
        experimentDeleteRequest.getNamespace(),
        null);
  ...
  public RestResponse<PageQueryResponse<UserExperiment>> pageableQueryUserExperiments(
    ...
    // 免登下的演练查询
    Response<PageQueryResponse<UserExperiment>> result =
        userPermissionService.getExperimentListByStsUserLogin(
  ...
  public RestResponse<Map<String, List<ExperimentActivityInfo>>> initMiniFlowByAppCode(
      @LoginUser ChaosUser chaosUser, @RequestBody InitMiniFlowRequest initMiniFlowRequest) {
    return RestResponseUtil.initWithServiceResponse(
        experimentWriteService.initMiniFlowByAppCode(initMiniFlowRequest));
  }

  @PostMapping(value = "/ListExperimentOperationLogs")
  public RestResponse<PageableResponse<ExperimentOperationLog>> listExperimentOperationLogs(
      @LoginUser ChaosUser chaosUser,
      @RequestBody ExperimentPageableQueryRequest baseExperimentRequest) {
    userPermissionService.checkExperimentPermission(
        PermissionTypes.R, chaosUser, baseExperimentRequest.getExperimentId(), null, null);
    return RestResponseUtil.initWithServiceResponse(
  ...
  public RestResponse<ExperimentRunResult> preCheckExperiment(
      @LoginUser ChaosUser chaosUser, @RequestBody ExperimentRunRequest experimentRunRequest)
      throws ChaosException {
    userPermissionService.checkExperimentPermission(
        PermissionTypes.X,
  ...
  public RestResponse<List<ExperimentAppRisk>> checkExperimentAppRiskMessage(
      @LoginUser ChaosUser chaosUser, @RequestBody ExperimentAppRiskMessageRequest request) {
    return RestResponseUtil.initWithServiceResponse(
  ...
  public RestResponse<ExperimentInfo> initExperimentByAppCode(
      @LoginUser ChaosUser chaosUser, @RequestBody InitMiniFlowRequest initMiniFlowRequest) {
    Response<Map<String, List<ExperimentActivityInfo>>> response =
        experimentWriteService.initMiniFlowByAppCode(initMiniFlowRequest);
  ...
  public RestResponse<Boolean> updateExperimentHost(
      @LoginUser ChaosUser chaosUser,
      @RequestBody ExperimentHostUpdateRequest experimentHostUpdateRequest)
      throws ChaosException {
    userPermissionService.checkExperimentPermission(
        PermissionTypes.W,
        chaosUser,
        experimentHostUpdateRequest.getExperimentId(),
        experimentHostUpdateRequest.getNamespace(),
        null);
    return RestResponseUtil.initWithServiceResponse(
