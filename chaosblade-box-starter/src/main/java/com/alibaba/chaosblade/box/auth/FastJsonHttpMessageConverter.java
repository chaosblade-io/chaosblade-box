...
public class FastJsonHttpMessageConverter extends AbstractHttpMessageConverter<Object> //
  ...
  @Deprecated protected SerializerFeature[] features = new SerializerFeature[0];

  @Deprecated protected SerializeFilter[] filters = new SerializeFilter[0];
  ...
  protected void writeInternal(Object object, HttpOutputMessage outputMessage)
    ...
    try {
      ...
      List<SerializeFilter> allFilters =
          new ArrayList<SerializeFilter>(Arrays.asList(globalFilters));
