...
public class AgentPingScheduleJob extends BaseJob implements Job, InitializingBean, DisposableBean {
  ...
  private static final ThreadPoolExecutor rejectedThreadPool =
  ...
  private static final ExecutorService countDeviceExecutor =
      new ThreadPoolExecutor(
          3,
          5,
          0,
          ...
          new RejectedExecutionHandler() {
            ...
            public void rejectedExecution(Runnable runnable, ThreadPoolExecutor executor) {
              ...
              log.warn(
                  "[AgentPingScheduleJob] BlockingQueue is full, RejectedExecutionHandler is running");
              try {
  ...
  public void execute(JobExecutionContext context) throws JobExecutionException {
    ...
    for (int page = 1; ; page++) {
      ...
      PageableResponse<DeviceDO> deviceDOPageableResponse =
          deviceRepository.getAliveDevices(pageableQueryWrapper);

      deviceDOPageableResponse.getData().stream()
      ...
      log.info(
          ...
          deviceDOPageableResponse.getTotal());
