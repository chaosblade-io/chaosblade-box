...
public class ExperimentTaskController extends BaseController {
  ...
  @Resource private ExperimentTaskService experimentTaskService;
  ...
  public RestResponse<ExperimentTaskSummary> getExperimentTask(
    ...
    PermissionResult permissionResult =
        userPermissionService.checkExperimentTaskPermission(
            PermissionTypes.R, chaosUser, experimentTaskId);
    Response<ExperimentTaskSummary> experimentTaskSimpleResponse =
        experimentTaskService.getExperimentTaskSummary(experimentTaskId);
  ...
  public RestResponse<ExperimentTaskSimple> getSimpleExperimentTaskInfo(
      @LoginUser ChaosUser chaosUser,
      @RequestBody BaseExperimentTaskRequest baseExperimentTaskRequest) {
    String experimentTaskId = baseExperimentTaskRequest.getTaskId();
    userPermissionService.checkExperimentTaskPermission(
  ...
  public RestResponse<List<ExperimentTask>> queryExperimentTasksByExperimentId(
    ...
    userPermissionService.checkExperimentPermission(
        PermissionTypes.R, chaosUser, experimentId, baseExperimentRequest.getNamespace(), null);
    return RestResponseUtil.initWithServiceResponse(
  ...
  public RestResponse<Void> stopExperimentTaskId(
      @LoginUser ChaosUser chaosUser,
      @RequestBody BaseExperimentTaskRequest baseExperimentTaskRequest)
      throws PermissionDeniedException {
    String experimentTaskId = baseExperimentTaskRequest.getTaskId();
    userPermissionService.checkExperimentTaskPermission(
        PermissionTypes.X, chaosUser, experimentTaskId);
    return RestResponseUtil.initWithServiceResponse(
        experimentTaskService.stopTask(
            chaosUser, experimentTaskId, new ExperimentTaskStopOption()));
  }

  @ApiOperation(value = "停止所有演练")
  @PostMapping(value = "/StopAllExperimentTasks")
  public RestResponse<Void> stopUserExperimentTaskId(
      @LoginUser ChaosUser chaosUser,
      @RequestBody BaseExperimentTaskRequest baseExperimentTaskRequest) {
    return RestResponseUtil.initWithServiceResponse(
  ...
  public RestResponse<ExperimentStat> experimentTaskStatistic(
      @LoginUser ChaosUser chaosUser,
      @RequestBody BaseExperimentTaskRequest baseExperimentTaskRequest) {
  ...
  public RestResponse<ExperimentStat> experimentTaskStatisticIgnoreNamespace(
      @LoginUser ChaosUser chaosUser) {
    UserExperimentStatRequest userExperimentTaskStatRequest = new UserExperimentStatRequest();
    userExperimentTaskStatRequest.setUser(chaosUser);
    return RestResponseUtil.initWithServiceResponse(
  ...
  public RestResponse<List<ExperimentTaskSimple>> getExperimentTasksSimpleByExperimentId(
      @LoginUser ChaosUser chaosUser, @RequestBody ExperimentTaskRequest experimentTaskRequest) {
  ...
  public RestResponse<ExperimentTaskResult> queryExperimentTasksResultByExperimentId(
      @LoginUser ChaosUser chaosUser, @RequestBody ExperimentTaskRequest experimentTaskRequest) {
    String experimentId = experimentTaskRequest.getExperimentId();
    userPermissionService.checkExperimentTaskPermission(PermissionTypes.R, chaosUser, experimentId);
    return RestResponseUtil.initWithServiceResponse(
  ...
  public RestResponse<Map<String, Integer>> experimentTaskResultCount(
      @LoginUser ChaosUser chaosUser, @RequestBody ExperimentTaskRequest experimentTaskRequest) {
    String experimentId = experimentTaskRequest.getExperimentId();
    userPermissionService.checkExperimentTaskPermission(PermissionTypes.R, chaosUser, experimentId);
    return RestResponseUtil.initWithServiceResponse(
  ...
  public RestResponse<ExperimentTaskLog> getExperimentTaskLog(
      @LoginUser ChaosUser chaosUser,
      @RequestBody BaseExperimentTaskRequest baseExperimentTaskRequest)
      throws PermissionDeniedException {
    String experimentTaskId = baseExperimentTaskRequest.getTaskId();
    userPermissionService.checkExperimentTaskPermission(
        PermissionTypes.R, chaosUser, experimentTaskId);
    return RestResponseUtil.initWithServiceResponse(
        experimentTaskService.getExperimentTaskLog(experimentTaskId));
  }
  ...
  public RestResponse<ExperimentTaskControl> getControlList(
    ...
    return RestResponseUtil.initWithServiceResponse(
        experimentTaskService.getControlList(experimentTaskRequest));
  }
  ...
  public RestResponse<PageQueryResponse<BaseExperimentTask>> experimentTaskSummaryPageableQuery(
      @RequestBody ExperimentPageableQueryRequest experimentPageableQueryRequest) {
  ...
  public RestResponse<ExperimentTaskGuardsResult>
      QueryExperimentTaskGuardInfoqueryExperimentTaskGuardInfo(
          @LoginUser ChaosUser chaosUser,
          @RequestBody BaseExperimentTaskRequest baseExperimentTaskRequest) {
    baseExperimentTaskRequest.setUser(chaosUser);
    Response<ExperimentTaskGuardsResult> response =
  ...
  public RestResponse<Map<String, Integer>> queryExperimentAmount(
      @LoginUser ChaosUser chaosUser, @RequestBody OrderQueryRequest request) {
    if (null == request || Strings.isNullOrEmpty(request.getExperimentId())) {
      throw new ChaosException(
          CommonErrorCode.P_ARGUMENT_ILLEGAL, "experimentId cannot be null or empty.");
    }

    Supplier<Pair<String, Integer>> forecastAmountSupplier =
        () -> Pair.of("forecastAmount", forecastExperimentAmount(request).getResult());
  ...
  public RestResponse<Integer> forecastExperimentAmount(@RequestBody OrderQueryRequest request) {
    ...
    List<Host> hosts =
        experimentFlowDefinitionManager.findAllHostsByExperimentId(request.getExperimentId());
