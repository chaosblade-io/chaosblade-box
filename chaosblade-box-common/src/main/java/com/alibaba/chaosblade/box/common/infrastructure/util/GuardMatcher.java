...
public class GuardMatcher {
  ...
  public static boolean match(
      Object actualValue, List<RecoveryStrategyFieldArgumentDefinition> strategies) {
    return match(actualValue, strategies, true);
  }

  public static boolean match(
      Object actualValue,
      List<RecoveryStrategyFieldArgumentDefinition> strategies,
      boolean andOperationFirst) {
  ...
  @Nullable private static Pair<String, Boolean> generateExpression(
      RecoveryStrategyFieldArgumentDefinition strategy) {
    ...
    if (value instanceof Number) {
      ...
      if (Objects.equals(
          condition.getValue(), ConditionArgumentDefinitionOperation.LENGTH.getValue())) {
