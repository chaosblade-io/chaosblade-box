...
/**
 * 错误码规范, S-1001,代表系统错误,取值范围是1000~1999 B-2000~2999,代表业务错误 P-3000~3001,代表参数错误
 *
 * @author haibin
 */
public enum CommonErrorCode implements IErrorCode {
  ...
  /** P代表参数错误或者请求违法 0,通用,3000~3099 1.用户权限相关 3100~3199 2.api相关:3200~-3299 3.3300~3399 演练参数相关 */
  ...
  /** 系统级别的错误 通用错误：1000~1099 数据库错误:1100~1199 缓存错误:1200~1299 外部系统错误:1300~1399 */
