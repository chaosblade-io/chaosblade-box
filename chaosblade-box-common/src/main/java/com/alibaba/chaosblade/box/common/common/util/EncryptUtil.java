...
public class EncryptUtil {
    ...
    try {
      PRIVATE_KEY =
          CharStreams.toString(
                  new InputStreamReader(privateKeyResource.getInputStream(), Charsets.UTF_8))
              .trim();
      PUBLIC_KEY =
          CharStreams.toString(
                  new InputStreamReader(publicKeyResource.getInputStream(), Charsets.UTF_8))
              .trim();
    } catch (IOException e) {
  ...
  public static String reEncryptPassword(String data)
  ...
  public static void main(String[] args)
      throws NoSuchAlgorithmException, IllegalBlockSizeException, InvalidKeyException,
          BadPaddingException, NoSuchPaddingException, IOException, InvalidKeySpecException {
    generateKeyPair();
  }
}
