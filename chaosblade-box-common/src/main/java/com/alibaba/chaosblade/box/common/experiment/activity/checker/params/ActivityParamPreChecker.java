...
public abstract class ActivityParamPreChecker {
  ...
  protected List<ActivityGroupDefinitionCheckItem.ActivityGroupDefinitionParamCheckResult>
      checkArguments(
          ActivityParamPreCheckContext activityParamPreCheckContext,
          ExperimentActivityInfo experimentActivityInfo) {
    return sceneArgumentGradeConverter.tranToArgumentsList(experimentActivityInfo.getArguments())
        .stream()
        .map(
            new Function<
                SceneArgumentDefinition,
                ActivityGroupDefinitionCheckItem.ActivityGroupDefinitionParamCheckResult>() {
              @Override
              public ActivityGroupDefinitionCheckItem.ActivityGroupDefinitionParamCheckResult apply(
                  SceneArgumentDefinition sceneArgumentDefinition) {
                try {
                  return checkArgument(
                      activityParamPreCheckContext,
                      experimentActivityInfo,
                      sceneArgumentDefinition);
                } catch (NumberFormatException numberFormatException) {
                  ActivityGroupDefinitionCheckItem.ActivityGroupDefinitionParamCheckResult
                      activityGroupDefinitionParamCheckResult =
                          new ActivityGroupDefinitionCheckItem
                              .ActivityGroupDefinitionParamCheckResult();
                  activityGroupDefinitionParamCheckResult.setAlias(
                  ...
                  activityGroupDefinitionParamCheckResult.setAlias(
                      sceneArgumentDefinition.getAlias());
                  activityGroupDefinitionParamCheckResult.setError(
        ...
        .filter(
            new Predicate<
              ...
              public boolean test(
                  ActivityGroupDefinitionCheckItem.ActivityGroupDefinitionParamCheckResult
                      activityGroupDefinitionParamCheckResult) {
                return activityGroupDefinitionParamCheckResult != null
                    && !Strings.isNullOrEmpty(activityGroupDefinitionParamCheckResult.getError());
              }
            })
  ...
  protected ActivityGroupDefinitionCheckItem.ActivityGroupDefinitionParamCheckResult checkArgument(
    ...
    activityGroupDefinitionParamCheckResult =
        internalCheckArgument(
            activityParamPreCheckContext, experimentActivityInfo, sceneArgumentDefinition);
  ...
  protected abstract ActivityGroupDefinitionCheckItem.ActivityGroupDefinitionParamCheckResult
      internalCheckArgument(
          ActivityParamPreCheckContext activityParamPreCheckContext,
          ExperimentActivityInfo experimentActivityInfo,
          SceneArgumentDefinition sceneArgumentDefinition);
