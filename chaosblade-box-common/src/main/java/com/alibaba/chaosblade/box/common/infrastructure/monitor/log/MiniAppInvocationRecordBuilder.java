...
public final class MiniAppInvocationRecordBuilder {
  ...
  private MiniAppInvocationRecordBuilder() {
    miniAppInvocationRecord = new MiniAppInvocationRecord();
  }

  public static MiniAppInvocationRecordBuilder aMiniAppInvocationRecord() {
    return new MiniAppInvocationRecordBuilder();
  }

  public static MiniAppInvocationRecordBuilder init(
      String requestId, ChaosAppRequest chaosAppRequest, String appCode) {
