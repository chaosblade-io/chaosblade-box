...
public final class ParamAsserts {
  ...
  private static Pattern StringDot = Pattern.compile("(\\w+,)*(\\w+)");
  ...
  public static void assertNumberGt(String value, BigDecimal bigDecimal) {
    Preconditions.checkArgument(
        new BigDecimal(value).compareTo(bigDecimal) > 0, "需要大于:" + bigDecimal.floatValue());
  }
  ...
  public static void assertNumberGe(String value, BigDecimal bigDecimal) {
    Preconditions.checkArgument(
        new BigDecimal(value).compareTo(bigDecimal) >= 0, "必须大于等于:" + bigDecimal.floatValue());
  }

  public static void assertNumberEq(String value, BigDecimal bigDecimal) {
    Preconditions.checkArgument(
        new BigDecimal(value).compareTo(bigDecimal) == 0, "必须等于:" + bigDecimal.floatValue());
  }

  public static void assertNumberLt(String value, BigDecimal bigDecimal) {
    Preconditions.checkArgument(
        new BigDecimal(value).compareTo(bigDecimal) < 0, "需要小于:" + bigDecimal.floatValue());
  }

  public static void assertNumberLe(String value, BigDecimal bigDecimal) {
    Preconditions.checkArgument(
        new BigDecimal(value).compareTo(bigDecimal) <= 0, "必须小于等于:" + bigDecimal.intValue());
  }
  ...
  public static void assertNumberIn(String value, BigDecimal from, BigDecimal to) {
    ...
    Preconditions.checkArgument(
        bigDecimal.compareTo(from) >= 0 && bigDecimal.compareTo(to) <= 0,
  ...
  public static void assertPort(String value) {
    ...
    Preconditions.checkArgument(
        bigDecimal.compareTo(new BigDecimal(0)) >= 0
            && bigDecimal.compareTo(new BigDecimal(65535)) <= 0,
        "端口必须在[" + 0 + "," + 65535 + "]内");
  }
  ...
  public static void assertValidIp(String value) {
    Preconditions.checkArgument(
        SystemUtils.isValidIpAddress(value) || SystemUtils.isValidIpSubMask(value),
  ...
  public static void assertStringIn(String value, Set<String> options) {
    Preconditions.checkArgument(options.contains(value), "须在[" + options.toString() + "]内");
  }
}
