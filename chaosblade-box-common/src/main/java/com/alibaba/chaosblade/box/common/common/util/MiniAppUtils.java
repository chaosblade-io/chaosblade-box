...
public final class MiniAppUtils {
  ...
  public static boolean isJvm(String appCode) {
    return isFromChaosBlade(appCode)
        && ChaosBladeMetaData.getInstance().getChaosBladeAction(appCode) != null
  ...
  public static boolean isChaosRecovery(String appCode) {
    ...
    return chaosBladeAction != null
        && ChaosBladeActionType.STOP_ATTACK.equals(chaosBladeAction.getActionType());
  }
  ...
  public static PhaseType getPhaseByAppCode(String appCode) {
    ...
    if (ChaosBladeActionType.STOP_ATTACK.equals(actionType)
        || ChaosBladeActionType.UNINSTALL_AGENT.equals(actionType)) {
  ...
  public static String getRecoverCode(String appCode) {
    ...
    if (appCode.endsWith(JVM_AGENT_INSTALL_SUFFIX)) {
      return appCode.replace("install", "uninstall");
    }
    return appCode + ".stop";
  }
  ...
  public static boolean isDisk(String appCode) {
    return appCode.endsWith("disk.burn")
        || appCode.endsWith("disk.iohang")
        || appCode.endsWith("disk.fill");
  }
}
