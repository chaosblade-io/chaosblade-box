...
/** @author haibin.lhb */
@Component
public class ChaosBladeTimeOutSceneFunctionParametersInterceptor
    implements SceneFunctionParametersInterceptor {
  @Override
  public void afterQuery(
    ...
    if (MiniAppUtils.isFromChaosBlade(sceneFunctionDO.getCode())) {
      parameters.removeIf(
          parameter ->
              Objects.equals(
                  parameter.getAlias(), ChaosBladeTimeOutSetterActivityInvokeInterceptor.param));
    }
  }
