...
public class MiniAppInvokeModeHandleInvokeInterceptor extends BaseActivityInvokeInterceptor {
  ...
  public boolean preHandle(
    ...
    activityInvokeContext
        ...
        .getChaosAppContext()
        .addData(
            "experiment_task_id", activityInvokeContext.getContextData().getExperimentTaskId());
    if (!MiniAppUtils.isFromChaosBlade(activityInvokeContext.getExecutableAppCode())) {
      ChaosFunctionDescriptor chaosFunctionDescriptor =
          (ChaosFunctionDescriptor)
              ChaosAppUtil.getChaosMethodDescriptor(activityInvokeContext.getExecutableAppCode());
