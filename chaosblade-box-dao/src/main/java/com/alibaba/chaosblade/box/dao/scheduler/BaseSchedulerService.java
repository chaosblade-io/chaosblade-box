...
public abstract class BaseSchedulerService implements SchedulerJobService {
  ...
  public String addSchedulerJob(SchedulerJobCreateRequest schedulerJobCreateRequest) {
    Preconditions.checkArgument(
        schedulerJobCreateRequest.getBusinessId() != null, "businessId Required");
    Preconditions.checkArgument(
        schedulerJobCreateRequest.getBusinessType() != null, "businessType Required");
    Preconditions.checkArgument(
        schedulerJobCreateRequest.getClassName() != null, "className Required");
    ...
    try {
      if (schedulerJobDO != null) {
        log.warn(
            "exist scheduler task by businessType:{},businessId:{},taskId:{},class:{}",
            schedulerJobCreateRequest.getBusinessType(),
            schedulerJobCreateRequest.getBusinessId(),
        ...
        log.info(
            "update scheduler job success,taskId:{},schedulerXJobId:{}",
            schedulerJobDO.getJobId(),
            schedulerJobDO.getJobId());
        ...
        log.info(
            "create scheduler job success,taskId:{},schedulerXJobId:{}",
            schedulerJobDO.getJobId(),
            schedulerJobDO.getJobId());
        return schedulerJobDO.getJobId();
      }
  ...
  private void fillSchedulerJobDO(
      SchedulerJobDO schedulerJobDO, SchedulerJobCreateRequest schedulerJobCreateRequest) {
  ...
  protected abstract void internalAddSchedulerJob(SchedulerJobDO schedulerJob)
      throws SchedulerException;

  @Override
  public String disableSchedulerJobByBusinessId(Integer businessType, String businessId) {
    SchedulerJobDO schedulerJobDO =
        schedulerJobRepository.findByBusinessIdAndBusinessType(businessType, businessId);
    if (schedulerJobDO == null) {
      return null;
    }
  ...
  protected abstract void internalDeleteSchedulerJob(SchedulerJobDO schedulerJob)
      throws SchedulerException;
  ...
  public boolean updateSchedulerJob(SchedulerJobUpdateRequest schedulerJobUpdateRequest) {
    Preconditions.checkArgument(
        schedulerJobUpdateRequest.getBusinessId() != null, "businessId Required");
    Preconditions.checkArgument(
        schedulerJobUpdateRequest.getBusinessType() != null, "businessType Required");
    SchedulerJobDO schedulerJobDO =
        schedulerJobRepository.findByBusinessIdAndBusinessType(
  ...
  private void internalUpdateSchedulerJob(
      SchedulerJobUpdateRequest schedulerJobUpdateRequest, SchedulerJobDO schedulerJobDO) {
