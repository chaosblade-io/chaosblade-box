...
public class ExperimentMiniAppTaskDO extends BaseTaskDO {
  ...
  @TableField private String data;
  ...
  /** chaosblade注入ID,只有注入阶段才有 {@link ChaosBladeExpUidDO} */
  ...
  /**
   * 宿主机的配置ID 1.如果注入对象是主机,那么就是主机ConfigurationId
  ...
  /**
   * 应用节点ID 1.如果注入对象是主机,那么就是主机ConfigurationId 2.如果注入对象是K8S的Container,Pods，那么就是所在Pod的ConfigurationId
   */
