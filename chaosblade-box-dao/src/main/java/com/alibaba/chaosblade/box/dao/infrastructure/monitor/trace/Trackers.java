...
public class Trackers implements DisposableBean, InitializingBean {
  ...
  @Autowired private List<ChangelogTracker> changelogTrackers;
  ...
  public void track(
      ChangelogTypes.ChangeActionType changeActionType,
      ChangelogTypes.ChangeOperatorType operatorType,
      String operatorId,
      ChangelogTypes.ChangeTargetType changeTargetType,
      String targetId,
      ChangelogTypes.ChangePropertyType changePropertyType,
      String propertyId,
      String description) {
    ChangelogDOBuilder builder =
        ChangelogDOBuilder.aChangelogDO()
            .withChangeType(changeActionType.getName())
    ...
    if (changePropertyType != null) {
      builder
          .withPropertyType(changePropertyType.getName())
  ...
  public void trackExperimentOperation(
      ChangelogTypes.ChangeActionType changeActionType,
      ChangelogTypes.ChangeOperatorType operatorType,
      ChaosUser chaosUser,
      String experimentId,
    ...
    track(
        changeActionType,
        operatorType,
        chaosUser.getCurrentUserId(),
        ChangelogTypes.ChangeTargetType.EXPERIMENT,
        experimentId,
        null,
        null,
        description);
  ...
  public void trackExperimentTaskOperation(
      ChangelogTypes.ChangeActionType changeActionType,
      ChangelogTypes.ChangeOperatorType operatorType,
      ChaosUser chaosUser,
      String experimentId,
    ...
    track(
        ...
        ChangelogTypes.ChangeTargetType.EXPERIMENT,
        experimentId,
        ChangelogTypes.ChangePropertyType.EXPERIMENT_TASK,
        experimentTaskId,
        null);
  }
