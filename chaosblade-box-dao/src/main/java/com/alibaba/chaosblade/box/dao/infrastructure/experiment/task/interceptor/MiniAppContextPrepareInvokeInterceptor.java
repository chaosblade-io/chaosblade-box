...
public class MiniAppContextPrepareInvokeInterceptor extends BaseActivityInvokeInterceptor {
  ...
  public boolean preHandle(
    ...
    activityInvokeContext
        ...
        .getChaosAppContext()
        .addData(EXPERIMENT_TASK_ID, experimentTaskDO.getTaskId());
    activityInvokeContext
        .getStepExecuteContext()
        .getChaosAppContext()
        .addData(EXPERIMENT_ID, experimentTaskDO.getExperimentId());
    activityInvokeContext
        .getStepExecuteContext()
        .getChaosAppContext()
        .addData(
            ...
            activityInvokeContext
                .getContextData()
                .getObject(ATTRIBUTE_KEY_ACTIVITY_TASK_DO, ActivityTaskDO.class));
    activityInvokeContext
        .getStepExecuteContext()
        .getChaosAppContext()
        .addData(CONTEXT_SETTINGS, activityInvokeContext.getContextData());
    return true;
  }
  ...
  public void afterHandle(
    ...
    activityInvokeContext
        ...
        .getChaosAppContext()
        .getData()
        .remove(EXPERIMENT_TASK_ID);
    activityInvokeContext
        .getStepExecuteContext()
        .getChaosAppContext()
        .getData()
        .remove(ACTIVITY_TASK_DO);
    activityInvokeContext
        .getStepExecuteContext()
        .getChaosAppContext()
        .getData()
        .remove(ATTRIBUTE_KEY_ACTIVITY_TASK_DO);
    activityInvokeContext
        .getStepExecuteContext()
        .getChaosAppContext()
        .getData()
        .remove(CONTEXT_SETTINGS);
  }
}
