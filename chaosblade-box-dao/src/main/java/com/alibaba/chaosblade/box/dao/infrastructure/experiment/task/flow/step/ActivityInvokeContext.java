...
public class ActivityInvokeContext extends InvokeContext {
  ...
  /** 拒绝演练的机器列表 key是 deviceConfigurationId value是原因 */
  ...
  public void setInvokeMode(InvokeMode invokeMode) {
    if (invokeMode != null) {
      getTempData().add(ActivityTaskExecutionAttributes.ATTRIBUTE_INVOKE_MODE, invokeMode);
    }
  }
  ...
  public InvokeMode getInvokeMode() {
    InvokeMode invokeMode =
        getTempData()
            .getObject(ActivityTaskExecutionAttributes.ATTRIBUTE_INVOKE_MODE, InvokeMode.class);
    if (invokeMode == null) {
