...
public class ChaosBladeAppInvoker implements MiniAppInvoker {
  ...
  public ChaosAppResponseReference invoke(MiniAppInvokeContext appInvokeContext) {
    ...
    if (chaosBladeAction == null) {
      chaosBladeAppResponse.setErrorMessage("appCode not found:" + appCode);
    ...
    ChaosBladeInvoker chaosBladeInvoker =
        appInvokeContext
            .getStepExecuteContext()
            .getFlowEngineContext()
            .getFlowEngineConfig()
            .getChaosBladeInvoker();
                ...
                new Supplier<Response>() {
                  ...
                  public Response get() {
                    ChaosBladeCreateExpRequest chaosBladeCreateExpRequest =
                        new ChaosBladeCreateExpRequest(appInvokeContext, chaosBladeAction);
                ...
                new Supplier<Response>() {
                  ...
                  public Response get() {
                    ChaosBladeDestroyExpRequest chaosBladeDestroyExpRequest =
                        new ChaosBladeDestroyExpRequest(
                            appInvokeContext.getHost(),
                            expId,
                        ...
                        new Supplier<Response<String>>() {
                          ...
                          public Response<String> get() {
                            ChaosBladePrepareExpRequest chaosBladePrepareExpRequest =
                                new ChaosBladePrepareExpRequest(appInvokeContext, chaosBladeAction);
                ...
                new Supplier<Response>() {
                  ...
                  public Response get() {
                    ChaosBladeRevokeExpRequest chaosBladeRevokeExpRequest =
                        new ChaosBladeRevokeExpRequest(appInvokeContext.getHost(), expId);
  ...
  /**
   * 安装agent 1.根据前一个expId查询是否正在运行，如果已经安装了就不需要再次安装 2.如果没有expId,那么久尝试安装，如果安装失败，说明有mk1的client，然后再卸载后安装
   */
  ...
  private void checkJavaAgentStatus(
      Response response,
      ChaosBladeInvoker chaosBladeInvoker,
      MiniAppInvokeContext appInvokeContext) {
    try {
      if (response != null
        ...
        Response<PrepareStatusBean> prepareStatusBeanResponse =
        ...
        if (ChaosBladeStatus.Revoked.name().equals(prepareStatusBean.getStatus())) {
          log.info(
              "[ChaosBladeAppInvoker] change response, expId: {},error:{}",
              expId,
              response.getError());
