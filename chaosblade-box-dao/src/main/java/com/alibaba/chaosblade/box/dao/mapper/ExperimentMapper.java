...
public interface ExperimentMapper extends BaseMapper<ExperimentDO> {
  ...
  @Select(
      "<script>"
          ...
          + "</script>")
  IPage<ExperimentDO> selectExperimentsByPage(
      IPage<ExperimentDO> page, @Param("query") ExperimentPageQuery experimentQuery);
  ...
  @Select(
      "<script>"
          ...
          + "</script>")
  @Results(
      id = "experimentSummaryInfoIn30Days",
      value = {
  ...
  List<ExperimentSummaryInfo> getExperimentSummaryInfoIn30Days(
      @Param("userId") String userId, @Param("namespace") String namespace);
  ...
  @Select(
      "<script>"
          ...
          + "</script>")
  @Results(
      id = "experimentSummaryInfo",
      value = {
        @Result(property = "resultState", column = "result_state"),
        @Result(property = "size", column = "size"),
      })
  List<ExperimentSummaryInfo> getExperimentSummaryInfo(
      @Param("userId") String userId, @Param("namespace") String namespace);
}
