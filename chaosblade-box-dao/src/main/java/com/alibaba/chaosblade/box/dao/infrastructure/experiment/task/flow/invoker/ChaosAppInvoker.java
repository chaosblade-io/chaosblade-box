...
public class ChaosAppInvoker {
  ...
  public static ChaosAppResponse invokeFromMiniApp(MiniAppInvokeContext miniAppInvokeContext) {
    ...
    ChaosAppContext chaosAppContext =
        miniAppInvokeContext.getStepExecuteContext().getChaosAppContext();
  ...
  public static ChaosAppResponse invokeByGuard(
      ChaosAppContext chaosAppContext,
  ...
  private static void logInvocation(
      ...
      ChaosAppRequest chaosAppRequest,
      StopWatch stopWatch,
      ChaosAppResponse result) {
    try {
      MiniAppInvocationRecordBuilder miniAppInvocationRecordBuilder =
          MiniAppInvocationRecordBuilder.init(
      ...
      RecordsRepo.getMiniAppInvocationRecorder()
          .record(
              miniAppInvocationRecordBuilder.build(
                  result.isSuccess(), result, stopWatch.getTime()));
  ...
  private static void logInvocation(
    ...
    try {
      MiniAppInvocationRecordBuilder miniAppInvocationRecordBuilder =
          MiniAppInvocationRecordBuilder.init(
              ChaosTraceUtil.generateTraceId(), chaosAppRequest, appCode);
      miniAppInvocationRecordBuilder.withExperimentTaskId(
          experimentGuardInstanceDO.getExperimentTaskId());
      RecordsRepo.getMiniAppInvocationRecorder()
          .record(
              miniAppInvocationRecordBuilder.build(
                  result.isSuccess(), result, stopWatch.getTime()));
  ...
  private static ChaosAppResponse invoke(
      String appCode, ChaosAppRequest chaosAppRequest, ChaosAppContext chaosAppContext) {
