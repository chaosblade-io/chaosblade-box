...
public class LogFormats {
  ...
  public static String buildThirdInterfaceRequestResult(
      String systemName, String interfaceName, Long cost, boolean success, String error) {
   ...
   * @return
   */
  public static String buildChaosBladeMessage(
      String appCode, MiniAppInvokeContext miniAppInvokeContext, Response response, String args) {
    return MessageFormatter.arrayFormat(
            "{}|{}|{}|{}|{}|{}|{}|{}",
            new Object[] {
              appCode,
              ...
              response.isSuccess(),
              response.getCode(),
              removeNewLineFlag(JSON.toJSONString(response.getResult())),
              miniAppInvokeContext.getMiniAppTaskId(),
              args
            })
        .getMessage();
  }
  ...
  public static class Activity {
    ...
    public static String buildBaseMessage(String messagePattern, Object... args) {
      return MessageFormatter.arrayFormat("ActivityTask={},Display={}," + messagePattern, args)
          .getMessage();
    }
    ...
    public static String buildUserConfirmedMessage(
        String activityTaskId, UserCheckState userCheckState) {
    ...
    public static String buildFinishedRunOnTarget(
        String activityTaskId, Host host, boolean success, String errorMessage) {
      return buildBaseMessage(
          "目标机器:{},执行结束,结果:{}",
          activityTaskId,
          true,
