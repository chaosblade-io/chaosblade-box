...
public final class SceneFunctionParameterDO extends BaseDO {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof SceneFunctionParameterDO)) {
      return false;
    }
    if (!super.equals(o)) {
      return false;
  ...
  public boolean isInvisibleWithNoDep() {
    ...
    return !sceneFunctionParameterLinkage.isDefaultState()
        && Strings.isNullOrEmpty(sceneFunctionParameterLinkage.getDepends());
  }
