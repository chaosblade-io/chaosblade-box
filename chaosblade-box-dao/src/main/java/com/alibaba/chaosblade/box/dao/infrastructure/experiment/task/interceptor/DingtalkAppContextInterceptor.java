...
public class DingtalkAppContextInterceptor extends BaseActivityInvokeInterceptor {
  ...
  public boolean preHandle(
    ...
    if (Objects.equals(appCode, CommonConstant.DINGTALK_APP_CODE_ROBOT_MESSAGE)) {
      ...
      ExperimentTaskDO experimentTask =
      ...
      activityInvokeContext
          ...
          .getChaosAppContext()
          .getData()
          .put(EXPERIMENT_TASK, convertExperiment(experimentTask));
      activityInvokeContext
          .getStepExecuteContext()
          .getChaosAppContext()
          .getData()
          .put(CURRENT_ACTIVITY_TASK, convertActivity(experimentTask, activityTask));
      ...
      if (null != nextTask) {
        activityInvokeContext
            ...
            .getChaosAppContext()
            .getData()
            .put(NEXT_ACTIVITY_TASK, nextTask);
      }
    }
    return true;
  }
  ...
  private ActivityTask convertActivity(
      ExperimentTaskDO experimentTask, ActivityTaskDO activityTask) {
    ...
    task.setStartTime(
        activityTask.getStartTime() == null
            ? activityTask.getGmtCreate()
            : activityTask.getStartTime());
    ...
    task.setUserCheckState(
        EnumUtil.integerValueOf(UserCheckState.class, activityTask.getUserCheckState()));
  ...
  public void afterHandle(
    ...
    activityInvokeContext
        ...
        .getChaosAppContext()
        .getData()
        .remove(EXPERIMENT_TASK);
    activityInvokeContext
        .getStepExecuteContext()
        .getChaosAppContext()
        .getData()
        .remove(CURRENT_ACTIVITY_TASK);
    activityInvokeContext
        .getStepExecuteContext()
        .getChaosAppContext()
        .getData()
        .remove(PRE_ACTIVITY_TASK);
    activityInvokeContext
        .getStepExecuteContext()
        .getChaosAppContext()
        .getData()
        .remove(NEXT_ACTIVITY_TASK);
  }
}
