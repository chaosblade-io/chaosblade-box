...
public class ActivityQueryManagerImpl implements ActivityQueryManager {
  ...
  public List<ExperimentActivityDO> findActivitiesByExperimentId(String experimentId) {
    return activityRepository.findActivities(experimentId);
  }
  ...
  @Override
  public List<ExperimentActivityDO> findActivitiesByPhase(
      String experimentId, PhaseType phaseType) {
    return activityRepository.findByExperimentIdAndPhase(experimentId, phaseType);
  }
}
