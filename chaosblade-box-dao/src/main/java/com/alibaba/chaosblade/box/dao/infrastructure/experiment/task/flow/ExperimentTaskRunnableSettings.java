...
public class ExperimentTaskRunnableSettings extends HashMapSettings {
  ...
  public boolean isMockMode() {
    return Optional.ofNullable(getExperimentTaskDO().getExperimentTaskContext())
        .map(ExperimentTaskContext::isMockMode)
        .orElse(false);
  }
  ...
  public int getMiniAppBatchCount() {
    return getAsInteger(
        ActivityTaskExecutionAttributes.ATTRIBUTE_KEY_ACTIVITY_RUNNABLE_BATCH_SIZE, 0);
  }
  ...
  public ExperimentActivityDO getExperimentActivityDO() {
    return getObject(
        ActivityTaskExecutionAttributes.ATTRIBUTE_KEY_EXPERIMENT_ACTIVITY,
        ExperimentActivityDO.class);
  }
  ...
  public void setExperimentActivityDefinition(
  ...
  public ExperimentTaskDO getExperimentTaskDO() {
    return getObject(
        ActivityTaskExecutionAttributes.ATTRIBUTE_KEY_EXPERIMENT_TASK, ExperimentTaskDO.class);
  }
  ...
  public boolean supportRepetitionExecution() {
    return getAsBoolean(
        ActivityTaskExecutionAttributes.ATTRIBUTE_ACTIVITY_SUPPORT_REPERTITION_EXECUTION, false);
  }
  ...
  public void setExperimentActivityId(String activityId) {
  ...
  public boolean isInterruptedExperimentTaskNow() {
    return getAsBoolean(
        ActivityTaskExecutionAttributes.ATTRIBUTE_KEY_INTERRUPTED_EXPERIMENT_TASK_NOW, false);
  }
}
