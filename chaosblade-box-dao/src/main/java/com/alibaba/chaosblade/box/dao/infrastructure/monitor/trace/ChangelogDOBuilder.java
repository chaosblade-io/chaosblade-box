...
public final class ChangelogDOBuilder {
  ...
  private ChangelogDOBuilder() {
    changelogDO = new ChangelogDO();
  }

  public static ChangelogDOBuilder aChangelogDO() {
    return new ChangelogDOBuilder();
  }
  ...
  public ChangelogDOBuilder but() {
    return aChangelogDO()
        .withId(changelogDO.getId())
        .withGmtCreate(changelogDO.getGmtCreate())
        .withGmtModified(changelogDO.getGmtModified())
        .withChangelogId(changelogDO.getChangelogId())
        .withChangeType(changelogDO.getChangeType())
        .withChangeDescription(changelogDO.getChangeDescription())
        .withTargetId(changelogDO.getTargetId())
        .withTargetDescription(changelogDO.getTargetDescription())
        .withTargetType(changelogDO.getTargetType())
        .withOperatorId(changelogDO.getOperatorId())
        .withOperatorDescription(changelogDO.getOperatorDescription())
        .withOperatorType(changelogDO.getOperatorType())
        .withPropertyId(changelogDO.getPropertyId())
        .withPropertyDescription(changelogDO.getPropertyDescription())
        .withPropertyType(changelogDO.getPropertyType())
        .withPropertyChangeType(changelogDO.getPropertyChangeType());
  }

  public ChangelogDO build() {
    return changelogDO;
  }
}
