...
public class ExperimentTaskRepository
    implements IRepository<String, ExperimentTaskDO>,
        IQuery<ExperimentTaskDO, ExperimentTaskQuery> {

  @Autowired private ExperimentTaskMapper experimentTaskMapper;
  ...
  public List<ExperimentTaskDO> findByExperimentId(String experimentId) {
    return experimentTaskMapper.selectList(
        new QueryWrapper<ExperimentTaskDO>().eq("experiment_Id", experimentId).orderByDesc("id"));
  }

  public List<ExperimentTaskDO> findUnfinishedExperimentTasks() {
    return experimentTaskMapper.selectList(
        new QueryWrapper<ExperimentTaskDO>()
  ...
  public List<ExperimentTaskDO> findByRunningExperimentTasksAndDurationTimeGtZero() {
    return experimentTaskMapper.selectList(
        new QueryWrapper<ExperimentTaskDO>()
            .eq("run_state", StateEnum.RUNNING.getValue())
            .ge("duration", 0));
  }
  ...
  public List<ExperimentTaskDO> findByExperimentIdsIn(List<String> experimentIds) {
    QueryWrapper<ExperimentTaskDO> queryWrapper =
        new QueryWrapper<ExperimentTaskDO>()
  ...
  public List<ExperimentTaskDO> findByUserIdAndRunState(String userId, StateEnum stateEnum) {
    return experimentTaskMapper.selectList(
        new QueryWrapper<ExperimentTaskDO>()
            .eq("user_id", userId)
  ...
  public List<ExperimentTaskDO> findByExperimentTasksOrderByExperimentDesc(
      String experimentId, Integer limit) {
    QueryWrapper<ExperimentTaskDO> queryWrapper = new QueryWrapper<ExperimentTaskDO>();
  ...
  public boolean updateFeedbackStatus(
      String experimentTaskId, FeedBackConstant.FeedbackStatus feedbackStatus) {
  ...
  public IPage<ExperimentTaskDO> findByExperimentTasksPageableOrderByCreateTimeDesc(
      String experimentId, int page, int size) {
    return experimentTaskMapper.selectPage(
  ...
  public IPage<ExperimentTaskDO> findByExperimentTasksPageableByUserIdOrderByCreateTimeDesc(
  ...
  public List<ExperimentTaskDO> findByOuterId(String outerId) {
    QueryWrapper<ExperimentTaskDO> queryWrapper =
        new QueryWrapper<ExperimentTaskDO>().eq("outer_id", outerId);
    return experimentTaskMapper.selectList(queryWrapper);
  }
  ...
  public boolean updateContext(
      String experimentTaskId, ExperimentTaskContext experimentTaskContext) {
    ExperimentTaskDO experimentTaskDO = new ExperimentTaskDO();
    experimentTaskDO.setTaskId(experimentTaskId);
  ...
  public List<ExperimentTaskDO> findTasksBetweenByExperimentId(
      String experimentId, Date startTime, Date endTime) {
  ...
  public List<ExperimentTaskDO> findFinishedTasksBetweenByExperimentId(
      String experimentId, Date startTime, Date endTime) {
    QueryWrapper<ExperimentTaskDO> queryWrapper =
        new QueryWrapper<ExperimentTaskDO>()
            .eq("experiment_id", experimentId)
  ...
  public List<ExperimentTaskDO> findTasksBetweenByExperimentIdsIn(
      List<String> experimentIds, Date startTime, Date endTime) {
    QueryWrapper<ExperimentTaskDO> queryWrapper =
        new QueryWrapper<ExperimentTaskDO>()
            .in(!CollectionUtil.isNullOrEmpty(experimentIds), "experiment_id", experimentIds)
            .ge("gmt_create", startTime)
  ...
  public List<ExperimentTaskDO> findFinishedTasksBetweenByExperimentIdsIn(
      List<String> experimentIds, Date startTime, Date endTime) {
    QueryWrapper<ExperimentTaskDO> queryWrapper =
        new QueryWrapper<ExperimentTaskDO>()
            .in(!CollectionUtil.isNullOrEmpty(experimentIds), "experiment_id", experimentIds)
