...
public class ActivityTargetRunnableStrategySelector {
  ...
  private static ActivityTargetsRunnableStrategy Default =
      new SequenceActivityTargetRunnableStrategy();
  ...
  public ActivityTargetsRunnableStrategy select(ActivityInvokeContext activityInvokeContext) {
    for (ActivityTargetsRunnableStrategy activityTargetsRunnableStrategy :
        targetsRunnableStrategyList) {
