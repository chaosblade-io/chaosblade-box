...
public class ActivityTargetExecutionResultRepository
  ...
  @Autowired private ExperimentActivityTargetTaskMapper experimentActivityTargetTaskMapper;
  ...
  public ExperimentMiniAppTaskDO findByActivityTaskIdAndHostAndAppCode(
      String activityTaskId, String host, String appCode) {
    QueryWrapper<ExperimentMiniAppTaskDO> queryWrapper = new QueryWrapper<>();
  ...
  public List<Host> findHostsByExperimentTaskAndPhase(
      String experimentTaskId, PhaseType phaseType) {
    QueryWrapper<ExperimentMiniAppTaskDO> queryWrapper = new QueryWrapper<>();
    ...
    return experimentActivityTargetTaskMapper.selectList(queryWrapper).stream()
        .map(
  ...
  public List<ExperimentMiniAppTaskDO> findByActivityTaskIdReturnSummary(String activityTaskId) {
    QueryWrapper<ExperimentMiniAppTaskDO> queryWrapper = new QueryWrapper<>();
    queryWrapper.select(
        ExperimentMiniAppTaskDO.class,
        new Predicate<TableFieldInfo>() {
          @Override
  ...
  public List<ExperimentMiniAppTaskDO> findRunningTask(String appCode) {
    QueryWrapper<ExperimentMiniAppTaskDO> experimentActivityTargetTaskDOQueryWrapper =
        new QueryWrapper<>();
    ...
    return experimentActivityTargetTaskMapper.selectList(
        experimentActivityTargetTaskDOQueryWrapper);
  }
  ...
  public List<ExperimentMiniAppTaskDO> findByActivityTaskIdAndResultNotSuccess(
      String activityTaskId) {
    QueryWrapper<ExperimentMiniAppTaskDO> queryWrapper = new QueryWrapper<>();
    queryWrapper.eq(DBConstant.ACTIVITY_TASK_ID, activityTaskId);
    queryWrapper.and(
        wrapper ->
            wrapper.ne("result_state", ResultEnum.SUCCESS.getValue()).or().isNull("result_state"));
    return experimentActivityTargetTaskMapper.selectList(queryWrapper);
  }
  ...
  public List<ExperimentMiniAppTaskDO> selectByTaskId(
      String experimentTaskId, PhaseType phaseType) {
    QueryWrapper<ExperimentMiniAppTaskDO> queryWrapper = new QueryWrapper<>();
    queryWrapper.eq(DBConstant.EXPERIMENT_TASK_ID, experimentTaskId);
    queryWrapper.eq(DBConstant.PHASE, phaseType);
  ...
  public List<ExperimentMiniAppTaskDO> findByExperimentTaskIdAndConfigurationIdAndState(
      String experimentTaskId, String configurationId, StateEnum stateEnum) {
    QueryWrapper<ExperimentMiniAppTaskDO> queryWrapper = new QueryWrapper<>();
    queryWrapper.eq(DBConstant.EXPERIMENT_TASK_ID, experimentTaskId);
  ...
  public List<ExperimentMiniAppTaskDO> findByHostAndExperimentTaskId(
      String host, String experimentTaskId) {
    QueryWrapper<ExperimentMiniAppTaskDO> queryWrapper = new QueryWrapper<>();
    queryWrapper.eq(DBConstant.EXPERIMENT_TASK_ID, experimentTaskId);
    queryWrapper.eq(DBConstant.HOST_IP, host);
    return experimentActivityTargetTaskMapper.selectList(queryWrapper);
  ...
  public ExperimentMiniAppTaskDO findOne(
    ...
    List<ExperimentMiniAppTaskDO> experimentMiniAppTaskDOS =
        experimentActivityTargetTaskMapper.selectList(
            buildQueryWrapper(activityTargetExecutionResultQuery));
    if (experimentMiniAppTaskDOS.isEmpty()) {
      return null;
    }
  ...
  private QueryWrapper<ExperimentMiniAppTaskDO> buildQueryWrapper(
    ...
    if (!Strings.isNullOrEmpty(activityTargetExecutionResultQuery.getActivityTaskId())) {
      queryWrapper.eq(
          DBConstant.ACTIVITY_TASK_ID, activityTargetExecutionResultQuery.getActivityTaskId());
    }
  ...
  public List<ExperimentMiniAppTaskDO> findRunningTasksByConfigurationId(String configurationId) {
    if (Strings.isNullOrEmpty(configurationId)) {
      return new ArrayList<>();
    }
    QueryWrapper<ExperimentMiniAppTaskDO> queryWrapper =
        new QueryWrapper<ExperimentMiniAppTaskDO>();
  ...
  public List<ExperimentMiniAppTaskDO> findRunningTaskByAppConfigurationIdAndPhase(
      String appConfigurationId, PhaseType phaseType) {
  ...
  public Set<String> findHostIpsByExperimentTaskId(String experimentTaskId) {
    ...
    return experimentActivityTargetTaskMapper.selectList(queryWrapper).stream()
        .map(ExperimentMiniAppTaskDO::getHostIp)
        .filter(Objects::nonNull)
        .collect(Collectors.toSet());
  }

  public List<ExperimentMiniAppTaskDO> findByExperimentTaskIdAndPhase(
      String experimentTaskId, PhaseType phaseType) {
  ...
  public IPage<ExperimentMiniAppTaskDO> pageableFindByErrorMessage(
      String errorMessage, int page, int size) {
    QueryWrapper<ExperimentMiniAppTaskDO> queryWrapper = new QueryWrapper<>();
    queryWrapper.eq(DBConstant.ERROR_MESSAGE, errorMessage);
    queryWrapper.eq("result_state", 1);
    return experimentActivityTargetTaskMapper.selectPage(
  ...
  public IPage<ExperimentMiniAppTaskDO> pageableFindByAppConfigurationIds(
      List<String> appConfigurationIds, int page, int size) {
    QueryWrapper<ExperimentMiniAppTaskDO> queryWrapper = new QueryWrapper<>();
