  ...
  private class ChaosAppRunner implements Runnable {
    ...
    public void run() {
      ...
      try {
        ...
        if (!result.isSuccess()) {
          ActivityTargetRetryInvokeChainNode chainNode =
              ChainFactory.createSpringChain(
                  applicationContext, ActivityTargetRetryInvokeChainNode.class);
        ...
        result =
            new ChaosAppResponse(
                false, null, exception.getMessage(), miniAppInvokeContext.getHost());
      }
