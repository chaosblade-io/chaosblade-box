...
public class SceneFunctionCategoryRelationRepository
  ...
  @Autowired private SceneFunctionCategoryRelationMapper sceneFunctionCategoryRelationMapper;
  ...
  public List<SceneFunctionCategoryRelationDO> findByCategoryId(String categoryId) {
    ...
    return sceneFunctionCategoryRelationMapper.selectList(
        new QueryWrapper<>(sceneFunctionCategoryRelationDO));
  }
  ...
  public int deleteByFunctionCode(String functionCode) {
    ...
    return sceneFunctionCategoryRelationMapper.delete(
        new QueryWrapper<>(sceneFunctionCategoryRelationDO));
  }
  ...
  public int countByCategoryId(String categoryId) {
    SceneFunctionCategoryRelationDO sceneFunctionCategoryRelationDO =
        new SceneFunctionCategoryRelationDO();
    sceneFunctionCategoryRelationDO.setCategoryId(categoryId);
    return sceneFunctionCategoryRelationMapper.selectCount(
        new QueryWrapper<>(sceneFunctionCategoryRelationDO));
  }
}
