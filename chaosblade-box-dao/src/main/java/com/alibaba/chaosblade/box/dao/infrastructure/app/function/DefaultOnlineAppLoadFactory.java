...
public class DefaultOnlineAppLoadFactory implements InitializingBean {
  ...
  private static List<String> getList(String path) throws IOException {
    ...
    Resource[] resources =
        new PathMatchingResourcePatternResolver()
            .getResources(
                ResourceUtils.CLASSPATH_URL_PREFIX + "scene/default_online_functions.json");
  ...
  public void afterPropertiesSet() throws Exception {
    try {
      List<String> productMessage =
          readProperties(LOAD_PATH, (new TypeReference<List<String>>() {}));
