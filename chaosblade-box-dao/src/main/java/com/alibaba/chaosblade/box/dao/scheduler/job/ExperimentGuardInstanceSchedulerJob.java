...
public class ExperimentGuardInstanceSchedulerJob extends BaseJob implements Job {
  ...
  public void execute(JobExecutionContext context) throws JobExecutionException {
    ...
    // experimentTaskRepository.findById(schedulerJobDO.getBusinessId()).get();
    //            List<ExperimentGuardInstanceDO> experimentGuardInstances =
    // experimentGuardInstanceRepository
    ...
    //                    "experiment task finished", schedulerJobDO.getBusinessId(),
    ...
    //                new ExperimentGuardInstanceExecutionRequest(experimentTaskDO,
    // experimentGuardInstances, true));
    //        }
  }
  ...
  private boolean isExperimentStopOverMinutes(ExperimentTaskDO experimentTaskDO) {
    return !experimentTaskDO.isRunning()
        && experimentTaskDO.getGmtEnd() != null
