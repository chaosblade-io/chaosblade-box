...
/**
 * Activity represents the steps that can be performed, There are many ways to implement
 * activities，like PluginActivity,ComponentActivity and so on
 *
 * @author haibin
 */
@Data
public class Activity implements Step {
  ...
  public Activity(
      ...
      ExperimentActivityDefinition definition) {
