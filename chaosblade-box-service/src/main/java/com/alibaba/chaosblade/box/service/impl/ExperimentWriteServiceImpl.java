...
public class ExperimentWriteServiceImpl implements ExperimentWriteService {
  ...
  @Override
  public Response<ExperimentRunResult> runExperiment(
      ChaosUser user, ExperimentRunRequest experimentRunRequest) throws ChaosException {
        ...
        experimentRunResultResponse -> {
          if (experimentRunResultResponse.isSuccess()) {
            trackers.trackExperimentTaskOperation(
                ChangeActionType.RUN,
                ChangeOperatorType.USER,
                user,
                experimentRunRequest.getExperimentId(),
                experimentRunResultResponse.getResult().getTaskId());
          }
        });
  }
  ...
  public Response<String> createExperiment(ExperimentCreateRequest experimentCreateRequest)
    ...
    return ChangeLogExecutor.executeWithChangeLog(
        ...
        experimentRunResultResponse -> {
          if (experimentRunResultResponse.isSuccess()) {
            trackers.trackExperimentOperation(
                ChangeActionType.ADD,
                ChangeOperatorType.USER,
                experimentCreateRequest.getUser(),
                experimentRunResultResponse.getResult(),
                null);
          }
        });
  }
  ...
  @Override
  public Response<Boolean> updateExperimentBasicInfo(
      ChaosUser user, ExperimentUpdateRequest experimentUpdateRequest) throws ChaosException {
    return ChangeLogExecutor.executeWithChangeLog(
        () -> commandBus.syncRun(ExperimentUpdateCommand.class, experimentUpdateRequest),
        experimentRunResultResponse -> {
          if (experimentRunResultResponse.isSuccess()) {
  ...
  @Override
  public Response<Void> updateExperimentDefinition(
      ExperimentDefinitionRequest flowDefinitionCreateRequest) {
    return ChangeLogExecutor.executeWithChangeLog(
        () ->
            commandBus.syncRun(
                ExperimentDefinitionUpdateCommand.class, flowDefinitionCreateRequest),
        experimentRunResultResponse -> {
          if (experimentRunResultResponse.isSuccess()) {
            trackers.trackExperimentOperation(
                ChangeActionType.Update,
                ...
                flowDefinitionCreateRequest.getExperimentId(),
                null);
          }
        });
  }
  ...
  @Override
  public Response<ExperimentRunResult> preCheckExperiment(
      ChaosUser user, ExperimentRunRequest experimentRunRequest) throws ChaosException {
  ...
  @Override
  public Response<Boolean> updateExperimentHost(
      ExperimentHostUpdateRequest experimentHostUpdateRequest) throws ChaosException {
