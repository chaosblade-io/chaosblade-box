...
public class OverviewProductLoadFactory implements InitializingBean {
  ...
  public static <T> T readProperties(String resourceLocation, TypeReference<T> javaType)
      throws IOException {
  ...
  public void afterPropertiesSet() throws Exception {
    try {
      List<OverviewProductMessage> productMessage =
          readProperties(LOAD_PATH_MESSAGE, (new TypeReference<List<OverviewProductMessage>>() {}));
    ...
    try {
      List<OverviewProductMessage> productMessage =
          readProperties(
              LOAD_PATH_PRACTICE, (new TypeReference<List<OverviewProductMessage>>() {}));
      messageList.addAll(productMessage);
    } catch (Exception e) {
