...
public interface UserPermissionService {
   ...
   */
  PermissionResult checkExperimentPermission(
      int permissionType,
      ChaosUser chaosUser,
      String experimentId,
      String nameSpace,
  ...
  void checkExperimentDeletePermission(
      int permissionType,
      ChaosUser chaosUser,
      String experimentId,
      String nameSpace,
   ...
   * @throws PermissionDeniedException
   */
  PermissionResult checkExperimentTaskPermission(
   ...
   * @throws PermissionDeniedException
   */
  void checkScenePermission(int permissionType, ChaosUser chaosUser, String sceneId)
      throws PermissionDeniedException;
   ...
   * @throws PermissionDeniedException
   */
  void checkUserApplicationPermission(int permissionType, ChaosUser chaosUser, Long appId)
      throws PermissionDeniedException;

  void checkUserApplicationPermission(
   ...
   * @param listResponse
   */
  void filterApplicationPair(
      ChaosUser chaosUser, Response<PageableResponse<AppNameAndIdPair>> listResponse);
   ...
   * @return
   */
  Response<PageQueryResponse<UserExperiment>> getExperimentListByStsUserLogin(
  ...
  void checkDeleteWorkspaceExperimentPermission(
