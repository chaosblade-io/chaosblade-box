...
public class QueryExpertiseDetailsCommand
  ...
  @Autowired private ExpertiseEvaluationRepository expertiseEvaluationRepository;

  @Override
  public Response<ExpertiseInfo> execute(
  ...
  private void fillEvaluationInfo(ExpertiseInfo expertiseInfo, ExpertiseDO expertiseDO) {
    ...
    List<ExpertiseEvaluationDO> expertiseEvaluationDOList =
        expertiseEvaluationRepository.findByExpertiseId(expertiseDO.getExpertiseId());
    expertiseEvaluationInfo.setItems(
        expertiseEvaluationDOList.stream()
            .map(
  ...
  private void fillExecutionInfo(
      ChaosUser user, ExpertiseInfo expertiseInfo, ExpertiseDO expertiseDO) {
  ...
  private void fillRunTimeInfo(
      ExpertiseExecutableInfo expertiseExecutableInfo, ExpertiseDO expertiseDO) {
