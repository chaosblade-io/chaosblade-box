...
public interface ExperimentTaskService {
  ...
  /**
   * 根据演练ID获取演练任务简单信息(包含主机信息，类型信息，应用信息) 不获取正在运行中的信息
   *
   ...
   * @return
   */
  Response<ExperimentTaskResult> getExperimentTasksResultByExperimentId(
      ExperimentTaskRequest experimentTaskRequest);
   ...
   * @return
   */
  Response<Map<String, Integer>> getExperimentTaskResultCount(
      ExperimentTaskRequest experimentTaskRequest);
