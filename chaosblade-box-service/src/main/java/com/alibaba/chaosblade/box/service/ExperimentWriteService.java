...
public interface ExperimentWriteService {
   ...
   */
  Response<ExperimentRunResult> runExperiment(
   ...
   * @throws ChaosException
   */
  Response<Boolean> updateExperimentBasicInfo(
   ...
   * @return
   */
  Response<Void> updateExperimentDefinition(
  ...
  /**
   * openApi使用，更新演练内容 根据入参，判断并更新演练基本信息、演练定义或者全部更新
   *
   * @param updateRequest
   * @return
   */
   ...
   * @throws ChaosException
   */
  Response<ExperimentRunResult> preCheckExperiment(
      ChaosUser user, ExperimentRunRequest experimentRunRequest) throws ChaosException;
   ...
   * @return
   */
  Response<ExperimentInit> initExperimentByAppCode(InitMiniFlowRequest initMiniFlowRequest);
