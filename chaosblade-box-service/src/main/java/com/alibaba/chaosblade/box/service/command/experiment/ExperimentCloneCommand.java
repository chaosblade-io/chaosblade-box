...
/** @author haibin */
@Component
public class ExperimentCloneCommand
    extends SpringBeanCommand<ExperimentCloneRequest, Response<String>> {
  ...
  private void fillExperimentCreateRequest(
      ExperimentCloneRequest experimentCloneRequest,
      ExperimentCreateRequest experimentCreateRequest,
      ExperimentInfo experimentInfo) {
    // 填充基本信息
    ExperimentBasicInfo experimentBasicInfo = experimentInfo.getBasicInfo();
    String name =
        Strings.isNullOrEmpty(experimentBasicInfo.getName())
