...
@Component
@TaskLogRecord
@ActivityTaskHandlerType(ChaosConstant.PHASE_PREPARE)
public class PrepareActivityTaskHandler extends DefaultActivityTaskPhaseHandler {
    ...
    public void postHandle(ActivityTask activityTask, Throwable e) {
        ...
        long count = records.stream().filter(r ->
                r.getPhase().equals(ChaosConstant.PHASE_PREPARE)
