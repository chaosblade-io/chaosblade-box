 ...
 */
@Component
public class ExperimentToExpertiseConvertCommand
    extends SpringBeanCommand<BaseExperimentRequest, Response<String>> {

  private static final String DEFAULT = "To be added";
  ...
  public Response<String> execute(BaseExperimentRequest baseExperimentRequest) {
    ...
    Response<ExperimentInfo> experimentDOResponse =
        commandBus.syncRun(ExperimentInfoQueryCommand.class, request);
    ...
    ExperimentExpertiseCreateRequest experimentExpertiseCreateRequest =
        new ExperimentExpertiseCreateRequest();
  ...
  private ExpertiseBasicInfo buildExpertiseBasicInfo(ExperimentInfo experimentInfo) {
    ...
    expertiseBasicInfo.setFunctionDesc(
        Strings.isNullOrEmpty(experimentInfo.getBasicInfo().getDescription())
            ? DEFAULT
            : experimentInfo.getBasicInfo().getDescription());
