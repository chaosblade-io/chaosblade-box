...
public class PodController {
  ...
  @Resource private ApplicationDeviceController applicationDeviceController;
  ...
  public int delete(String userId, String environment, IdentifierModel identifierModel) {
    try {
      applicationDeviceController.delete(
          userId, DeviceType.POD, identifierModel.getConfigurationId());
      //            deviceInfoRepository.delete(userId, environment, DeviceType.POD.getType(),
      //                identifierModel.getHostConfigurationId(),
      // identifierModel.getConfigurationId());
    } catch (Exception e) {
