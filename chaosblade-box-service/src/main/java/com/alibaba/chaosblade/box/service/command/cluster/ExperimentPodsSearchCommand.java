...
public class ExperimentPodsSearchCommand
    extends SpringBeanCommand<ExperimentClusterQueryRequest, PageableResponse<ExperimentPodVO>> {

  @Autowired private ApplicationDeviceRepository applicationDeviceRepository;

  @Autowired private KubernetesDataRepository kubernetesDataRepository;

  @Autowired private DeviceRepository deviceRepository;

  @Override
  public PageableResponse<ExperimentPodVO> execute(
  ...
  private String getKubNamespace(
      String userId, String clusterId, String configurationId, String namespace) {
    Optional<KubernetesPod> kubernetesPodOptional =
        kubernetesDataRepository.findPodInfo(
