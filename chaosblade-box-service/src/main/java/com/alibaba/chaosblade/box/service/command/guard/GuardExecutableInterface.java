...
public interface GuardExecutableInterface {
   ...
   */
  default Map<Scope, List<ChaosMetricEntity>> invokeMetricMiniApp(
    ...
    for (Scope host : hosts) {
      ...
      ChaosAppResponse chaosAppResponse =
          internalInvoke(chaosAppContext, chaosAppRequest, appCode, experimentGuardInstanceDO);
  ...
  default ChaosAppResponse internalInvoke(
