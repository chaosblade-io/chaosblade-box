...
public class ActivityServiceImpl implements ActivityService {
  ...
  @Autowired private List<ActivityParamPreChecker> activityParamPreCheckers;
  ...
  public Response<ActivityGroupDefinitionCheckResponse> checkActivityGroupDefinition(
    ...
    return MethodInvokeUtil.invoke(
        () -> {
          Map<
                  String,
                  List<ActivityGroupDefinitionCheckItem.ActivityGroupDefinitionParamCheckResult>>
              idToResults = new HashMap<>();
          if (!CollectionUtil.isNullOrEmpty(activityGroupDefinitionCheckRequest.getFlows())) {
            ...
            ActivityParamPreCheckContext activityParamPreCheckContext =
                new ActivityParamPreCheckContext();
              ...
              miniFlow
                  ...
                  .forEach(
                      experimentActivityInfo ->
                          idToResults
                              .computeIfAbsent(
                                  experimentActivityInfo.getFontId(), s -> new ArrayList<>())
                              .addAll(
          ...
          List<ActivityGroupDefinitionCheckItem> activityGroupDefinitionCheckItems =
              idToResults.entrySet().stream()
          ...
          activityGroupDefinitionCheckResponse.setPassed(
              activityGroupDefinitionCheckItems.stream()
                  .flatMap(
                      (Function<
                              ActivityGroupDefinitionCheckItem,
                              Stream<
                                  ActivityGroupDefinitionCheckItem
                                      .ActivityGroupDefinitionParamCheckResult>>)
                          activityGroupDefinitionCheckItem ->
                              activityGroupDefinitionCheckItem.getParams().stream())
                  .allMatch(
                      activityGroupDefinitionParamCheckResult ->
  ...
  private List<ActivityGroupDefinitionCheckItem.ActivityGroupDefinitionParamCheckResult> doCheck(
    ...
    return activityParamPreCheckers.stream()
        .flatMap(
            new Function<
                ActivityParamPreChecker,
                Stream<
                    ActivityGroupDefinitionCheckItem.ActivityGroupDefinitionParamCheckResult>>() {
              @Override
              public Stream<
                      ActivityGroupDefinitionCheckItem.ActivityGroupDefinitionParamCheckResult>
                  apply(ActivityParamPreChecker activityParamPreChecker) {
                return Optional.ofNullable(
                    activityParamPreChecker.preCheck(
                        activityParamPreCheckContext, experimentActivityInfo))
