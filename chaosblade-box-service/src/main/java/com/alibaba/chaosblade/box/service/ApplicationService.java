...
public interface ApplicationService {
   ...
   * @return
   */
  Response<PageableResponse<CloudDevice>> getScopesByApplication(
   ...
   * @return
   */
  Response<List<AppNameAndIdPair>> getUserApplicationNames(
   ...
   * @return
   */
  Response<PageableResponse<AppNameAndIdPair>> pageUserApplicationNames(
      ApplicationSearchRequest applicationSearchRequest);
   ...
   * @return
   */
  Response<PageableResponse<ApplicationDeviceDO>>
   ...
   * @return
   */
  Response<Boolean> batchAddApplicationTag(
      ApplicationTagsBatchUpdateRequest applicationTagsUpdateRequest);
   ...
   * @return
   */
  Response<List<String>> searchDeviceTagsByAppIdAndGroupName(
   ...
   * @return
   */
  Response<Set<String>> searchClusterNamespacesByAppIdAndGroupName(
      ApplicationTagsSearchRequest applicationTagsSearchRequest);
   ...
   * @return
   */
  Response<ApplicationHostsCount> countScopesByApplication(
   ...
   * @return
   */
  Response<List<Host>> getScopeByConfigurationIds(
      ApplicationGroupDeviceQuery applicationGroupDeviceQuery);
   ...
   * @return
   */
  Response<List<ExperimentApplication>> findApplicationsInExperimentForVision(
