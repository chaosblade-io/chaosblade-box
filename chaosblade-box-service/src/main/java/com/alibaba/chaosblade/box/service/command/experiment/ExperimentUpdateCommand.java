...
@Component
@Slf4j
public class ExperimentUpdateCommand
  ...
  public Response<Boolean> execute(ExperimentUpdateRequest experimentUpdateRequest) {
    Response<ExperimentDO> response =
        experimentChecker.assertExperimentExist(experimentUpdateRequest.getExperimentId());
  ...
  private void internalExecute(
      ExperimentDO experimentDO, ExperimentUpdateRequest experimentUpdateRequest) {
  ...
  private void updateExperimentDO(
      ExperimentUpdateRequest experimentUpdateRequest, ExperimentDO experimentDO) {
    ...
    if (null != experimentUpdateRequest.getMiniAppDesc()
        && !experimentUpdateRequest.getMiniAppDesc().isEmpty()) {
  ...
  private void handleTags(
    ...
    tagManager.addTags(
        experimentUpdateRequest.getUserId(),
