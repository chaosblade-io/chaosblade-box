...
public class CloudNamespaceImpl implements NamespaceService {
  ...
  @Resource protected NamespaceRepository namespaceRepository;

  @Resource protected LicenseRepository licenseRepository;
  ...
  public List<Namespace> getUserNamespaces(String userId) {
    ...
    if (optional.isPresent()) {
      ...
      return namespaces.stream()
          //                .filter(namespaceDO ->
          // !ProtectedNamespace.contains(namespaceDO.getName()))
  ...
  @Override
  public Namespace addNamespace(String name, String userId, String description)
