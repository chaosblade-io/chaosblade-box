...
public interface ActivityTaskHandler {
     ...
     * @param activityTask
     */
    boolean preHandle(ActivityTaskExecuteContext context, ActivityTask activityTask);

    /**
     * @param activityTask
     */
    void handle(ActivityTaskExecuteContext context, ActivityTask activityTask);

    /**
     * @param activityTask
     */
    void postHandle(ActivityTaskExecuteContext context, ActivityTask activityTask, Throwable e);
